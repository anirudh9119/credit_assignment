...
from baselines.a2c.policies import CnnPolicy, LstmPolicy, LnLstmPolicy, ActorCnnPolicy, CnnValue
...
def train(env_id, num_frames, seed, policy, lrschedule, num_cpu):
    ...
    elif policy == 'ActorCnn':
        policy_fn = ActorCnnPolicy
    value_fn = CnnValue
    layer_norm = False
    critic = Critic(layer_norm=layer_norm)
    actor = Actor(nb_actions, layer_norm=layer_norm)
    learn(actor, critic, env, seed, total_timesteps=num_timesteps, lrschedule=lrschedule)
    env.close()
